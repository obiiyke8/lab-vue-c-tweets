...
<template>
  <div class="app">
    <!-- Iteration 2
    Comment once finished and go to iteration 9, so you can stop seeing 1 and start gettinng all tweets -->
    <!-- <Tweet :tweet="tweets[0]" /> -->

    <!-- In order to displahy all Tweets' incoming from the variable we have to iterate/loop through the data
    Remember that in vue we have the v-for iterator -->
